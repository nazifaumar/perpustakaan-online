...
<section>
    ...
    <form id="form_login" class="rounded-xl bg-white border-gray min-w-sm p-4 my-auto" action="" method="POST">
        ...
        <div class="mt-2 bg-white">
            ...
            <div class="input-group bg-white">
                <div class="input-group m-0 p-0 bg-white">
                    <input type="password" id="input_password" name="password" class="form-control bg-white" value="" required>
        ...
        <div class="text-center ">
            <div class="bg-white">
                <a class="w-100  btn-sm btn-link bg-white" style="text-decoration: none" href="/register"> Create Account </a>
            </div>
        </div>
    </form>
</div>
